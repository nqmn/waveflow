...
Usage:
    python main-web-v2.py --web        # Run web interface
    python main-web-v2.py --cli        # Run CLI interface
"""
...
def main():
    ...
    print('\n' + '='*60)
    print('RISNet v2.0 - Advanced RIS Network Simulator')
    print('='*60)
    print('\nFeatures:')
    print('  ✓ Multi-algorithm pathfinding (Dijkstra, A*, Greedy, Exhaustive)')
    print('  ✓ Advanced beam sweeping with CFAR detection')
    print('  ✓ Environment modeling with walls/obstacles')
    print('  ✓ Centralized RIS controller')
    ...
    if args.web:
        ...
        print("CLI mode not implemented yet. Use --web for web interface.")
    else:
        print("Usage: python main-web-v2.py --web")
