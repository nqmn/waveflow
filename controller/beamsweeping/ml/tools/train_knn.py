...
KNN model only ingests AP-to-RIS geometry because UE coordinates are unavailable.
...
def main():
    ...
    print(f"\nTraining KNN regression model with n_neighbors={args.n_neighbors}, weights={args.weights}, metric={args.metric}...")
